...
Ext.lib.Ajax = function() {
    ...
    function asyncRequest(method, uri, callback, postData,async,options) {
        var o = getConnectionObject() || null;
        var syncSuccess,syncCallback;
        if (o) {
            o.conn.open(method, uri, async);
            if(!async){
            	syncSuccess = options.success;
            	syncCallback = options.callback;
            ...
            if(syncSuccess && 
            	...
            	syncSuccess.call(options.scope||window,o.conn,options);
            }
            if(syncCallback){
            	syncCallback.call(options.scope||window,o.conn,options);
            }
        }
        return o;
    }
        ...
        request : function(method, uri, cb, data, options) {
            ...
            if(options){
                var me = this,
                    ...
                    async = Ext.isBoolean(options.async) ? options.async : true,
                    hs;
            ...
            return asyncRequest(method || options.method || "POST", uri, cb, data,async,options);
        },
